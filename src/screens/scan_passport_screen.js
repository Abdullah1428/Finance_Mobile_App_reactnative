...
const scan_passport_screen = ({navigation}) => {
    ...
    const handle_camera_button = async() => {
        try{
            if(camera)
            {
                ...
                setcamera_type(camera_type_back)
                navigation.navigate('scanned_passport',{image_passport:data.uri})
            }
        } catch (e) {
            console.log(e)
        }
        ...
        <SafeAreaView>
            ...
            <View style={{backgroundColor:'#131A30'}}>
                <View style={{marginTop: hp('2%')}}/>  
                    ...
                    <Text style={styles.text}>Scan your passport</Text>
                        <TouchableOpacity>
                            <Image
      			                style={{
                                      marginTop: hp('1.5%'),
                    ...
                    <View style={styles.progress}>
                        <Image
                            style={{resizeMode:'contain'}}
      			            source = {require('../screen_assets/scan_passport_screen/progress.png')}
      		            />
                ...
                <View style={{alignSelf:'center'}}>
                    <RNCamera
                        ...
                        <Image
                            ...
                            source = {require('../screen_assets/scan_passport_screen/picture_size.png')}
                        />
                    </RNCamera>
                        <View style={{marginTop:hp('2%')}}/>
                </View>
...
export default scan_passport_screen;