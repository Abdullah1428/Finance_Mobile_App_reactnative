...
const scan_address_screen = ({navigation}) => {
    ...
    const handle_camera_button = async() => {
        try{
            if(camera)
            {
                ...
                setcamera_type(camera_type_back)
                navigation.navigate('scanned_address',{image_address:data.uri})
            }
        } catch (e) {
            console.log(e)
        }
        ...
        <SafeAreaView>
            ...
            <View style={{backgroundColor:'#131A30'}}>
                <View style={{marginTop: hp('2%')}}/>  
                    ...
                    <Text style={styles.text}>Scan your Address</Text>
                        <TouchableOpacity>
                            <Image
      			                style={{
                                      marginTop: hp('1.5%'),
...
export default scan_address_screen;