...
const scan_license_screen = ({navigation}) => {
    ...
    const handle_camera_button = async() => {
        try{
            if(camera)
            {
                ...
                setcamera_type(camera_type_back)
                navigation.navigate('scanned_license',{image_license:data.uri})
            }
        } catch (e) {
            console.log(e)
        }
        ...
        <SafeAreaView>
            ...
            <View style={{backgroundColor:'#131A30'}}>
                <View style={{marginTop: hp('2%')}}/>  
                    ...
                    <Text style={styles.text}>Scan your Driving license</Text>
                        <TouchableOpacity>
                            <Image
      			                style={{
                                      marginTop: hp('1.5%'),
                ...
                <View style={{alignSelf:'center'}}>
                    <RNCamera
                        ...
                        <Image
                            ...
                            source = {require('../screen_assets/scan_license_screen/mask.png')}
                        />
                    </RNCamera>
                        <View style={{marginTop:hp('2%')}}/>
                </View>
...
export default scan_license_screen;