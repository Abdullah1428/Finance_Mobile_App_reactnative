...
const pay_transfer_initial_screen = ({navigation}) => {
                ...
                <View style={{
                    ...
                    <View>
                        ...
                        <View style={{flexDirection:'row'}}>
                            ...
                            <TouchableOpacity onPress={() => {handle_select_payee()}}>
                            <Ionicons name="ios-arrow-forward" size={20} color='white' style={{
                                marginLeft:wp('28%')
                            }}/>
                            </TouchableOpacity>
...
export default pay_transfer_initial_screen;