/* 
* @ react native app
* @ screen -> scanned passport screen
...
const scanned_passport_screen = ({navigation}) => {

    const image_passport = navigation.getParam('image_passport');
            ...
            <View>
             <View style={{marginTop: hp('2%')}}/>
                    ...
                    <View style={styles.statusbar}>
                        ...
                        <Text style={styles.text}>Here&apos;s the image of your passport</Text>
                        <TouchableOpacity>
                            <Image
      			                style={{
                                      marginTop: hp('1.5%'),
...
export default scanned_passport_screen;